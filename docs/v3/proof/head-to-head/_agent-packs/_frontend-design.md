# Frontend Design skill mode\n\nProduce a bold, distinctive design direction.\n- Strong design thesis first\n- Avoid generic AI aesthetics (purple gradients, cookie-cutter cards)\n- Typography, color, motion intentional\n- Ground in subject materials\n> Part of the **sitesmith** skill. Verbatim from [impeccable](https://github.com/pbakaus/impeccable) — Apache License 2.0, © Paul Bakaus.
