---
title: Creative surface draft — SKILL.md sections 1-8
state: S9_MINIMAL_IMPLEMENTATION
status: draft for smoke test S10-1
role: arm B in the re-expression transfer test
provenance: re-expressed from frontend-design (Apache-2.0), impeccable (Apache-2.0), taste-skill (MIT), ponytail (MIT), and this repository's own measurements
ai_generated: "(C)"
---
