...
building one customer website. The boundary is in [RELEASE-MAP.md](RELEASE-MAP.md).

## What is proven

- A clean installation can install pinned Playwright/axe dependencies and run the real gate with
  axe executing. Verification fails closed when axe is unavailable.
- Next.js, React/Vite and Astro select one matching adapter deterministically. Next.js and Astro
...
- Round-8 reviewers found the tannery's mobile specification table technically scrollable but
  visually unclear. That historical benchmark remains unchanged evidence.
