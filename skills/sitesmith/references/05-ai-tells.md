...
- [9. AI TELLS (Forbidden Patterns)](#9-ai-tells-forbidden-patterns)
  - [9.A Visual & CSS](#9a-visual-css)
  - [9.B Typography](#9b-typography)
  - [9.C Layout & Spacing](#9c-layout-spacing)
  - [9.D Content & Data ("Jane Doe" Effect)](#9d-content-data-jane-doe-effect)
  - [9.E External Resources & Components](#9e-external-resources-components)
  - [9.F Production-Test Tells (banned outright)](#9f-production-test-tells-banned-outright)
  - [9.G EM-DASH BAN (the single most-violated Tell)](#9g-em-dash-ban-the-single-most-violated-tell)
- [Æstetisk retning (frontend-design)](#stetisk-retning-frontend-design)
...
## Æstetisk retning (frontend-design)
