...
- [12. THE BLOCK LIBRARY (Contract - Implementations Land Here Iteratively)](#12-the-block-library-contract---implementations-land-here-iteratively)
  - [12.A File Location](#12a-file-location)
  - [12.B Required Frontmatter](#12b-required-frontmatter)
  - [12.C Required Body Sections](#12c-required-body-sections)
  - [12.D Block-Library Discipline](#12d-block-library-discipline)
- [13. OUT OF SCOPE](#13-out-of-scope)
- [14. FINAL PRE-FLIGHT CHECK](#14-final-pre-flight-check)
- [Appendix A - Install Commands per Design System](#appendix-a---install-commands-per-design-system)
- [Appendix B - Canonical Sources (read these before reinventing)](#appendix-b---canonical-sources-read-these-before-reinventing)
  ...
  - [Radix](#radix)
  - [shadcn/ui](#shadcnui)
  - [Native CSS / W3C standards](#native-css-w3c-standards)
  - [Apple Liquid Glass (Apple platforms only)](#apple-liquid-glass-apple-platforms-only)
- [Appendix C - Apple Liquid Glass: Honest Web Approximation](#appendix-c---apple-liquid-glass-honest-web-approximation)
  - [What is official](#what-is-official)
  - [What is NOT official](#what-is-not-official)
  - [Safer web approximation skeleton](#safer-web-approximation-skeleton)
